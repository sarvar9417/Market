        ...
        return (
          <div
            ...
            <div
              ...
              {order.position === 'rejection' ? (
                <div className='flex justify-end'>
                  <div className='w-full bg-red-600 rounded text-center font-bold text-white mb-1 py-1'>
                    Rad etilgan
                  </div>
                </div>
              ) : (
              ...
              <div className='text-white font-bold flex justify-center text-base  mb-2'>
                <span>{order.customermarket.name}</span>
              </div>
              ...
              <div className='text-white font-bold flex justify-between'>
                ...
                <span>
                  {order.customermarket.mainmarket === order.receivermarket
                    ? 'Filial'
                    : "Do'kon"}
                </span>
              </div>
